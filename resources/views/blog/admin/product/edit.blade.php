...
@section('content')
    <section class="content-header">
        @component('blog.admin.components.breadcrumb')
            ...
            @slot('product') Список продуктов {{$product->title}}@endslot
            @slot('active') Редактирование продукта @endslot
        @endcomponent
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="{{route('blog.admin.products.update',$product->id)}}" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" id="parent_id" class="form-control" required>
                                    ...
                                    @include('blog.admin.product.include.categories_for_prod',['categories'=>$catigories])
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="status" {{$product->hit ? 'checked':null}}> Статус
                                </label>
                            </div>
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="hit" {{$product->status ? 'checked':null}}> Хит
                                </label>
                            </div>
                            <div class="form-group has-feedback">
