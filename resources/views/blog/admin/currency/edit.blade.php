                        ...
                        <div class="box-body">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="Наименование валюты"
                                       value="{{$currency->title,old('title')}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="code" class="form-control" id="code" placeholder="Код валюты"
                                       value="{{$currency->code,old('code')}}" required>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            </div>
                            <div class="form-group">
                                <label for="symbol_left">Символ слева</label>
                                <input type="text" name="symbol_left" class="form-control" id="code"
                                       value="{{$currency->symbol_left,old('symbol_left')}}" placeholder="Символ слева">
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            </div>
                            <div class="form-group">
                                <label for="symbol_right">Символ справа</label>
                                <input type="text" name="symbol_right" class="form-control" id="value"
                                       value="{{$currency->symbol_right,old('symbol_right')}}" placeholder="Символ справа">
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            </div>
                            <div class="form-group has-feedback">
                                <label for="value">Значение</label>
                                <input type="text" name="value" class="form-control" id="value"
                                       value="{{$currency->value,old('value')}}" placeholder="Значение"
                            ...
                            <div class="form-group has-feedback">
                                <label for="value">
                                    <input type="checkbox" name="base" @if($currency->base) checked @endif>Базовая валюта
                                </label>
                            </div>
                        </div>
