                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @forelse($paginator as $user)
                                    @php
                                        $class = '';
                                        $status = $user->role;
                                        if ($status == 'disabled') $class = 'dancer';
                                    @endphp
                                    <tr class="{{$class}}">
                                        <td>{{$user->id}}</td>
                                        <td>{{$user->name}}</td>
                                        ...
                                        <td>
                                            <a href="{{route('blog.admin.users.edit',$user->id)}}"
                                               title="просмотреть пользователя"><i class="btn btn-xs"></i>
                                                <button type="submit" class="btn btn-success btn-xs">Просмотреть
                                                </button>
                                            </a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-xs">
                                                <form method="post"
                                                    ...
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger btn-xs delete">Удалить
                                                    </button>
                                                </form>
                                            </a>
                                        </td>
